...
const TodayEvents = ({ todayEvents, today, startHour, step, minuteHeight, direction }: TodayEventsProps) => {
    ...
    return (
        <Fragment>
            {todayEvents.map((event, i) => {
                ...
                const alreadyRendered = crossingEvents.filter(e => crossingIds.includes(e._id));
                crossingIds.push(event._id);
